...
module SuiBlogExample::article_aggregate {
    use std::string::String;
    use sui::tx_context;
    use SuiBlogExample::article;
    use SuiBlogExample::article_add_comment_logic;
    use SuiBlogExample::article_create_logic;
    use SuiBlogExample::article_delete_logic;
    use SuiBlogExample::article_remove_comment_logic;
    use SuiBlogExample::article_update_comment_logic;
    use SuiBlogExample::article_update_logic;
