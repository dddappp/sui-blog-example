...
public class HibernateTagV2StateQueryRepository implements TagV2StateQueryRepository {
    ...
    public TagV2State get(String id) {
        ...
        TagV2State state = (TagV2State)getCurrentSession().get(AbstractTagV2State.SimpleTagV2State.class, id);
    ...
    public Iterable<TagV2State> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(TagV2State.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<TagV2State> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(TagV2State.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public TagV2State getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<TagV2State> list = (List<TagV2State>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public TagV2State getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
